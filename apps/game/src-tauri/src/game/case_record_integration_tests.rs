use super::save::capture::{capture_checkpoint_v1, CapturedCheckpointV1};
use super::save::restore::{build_restore_candidate, load_current_definitions};
use super::save::schema::{SaveEnvelopeV1, SaveType, ThumbnailDescriptorV1};
...
fn save_envelope(engine: &GameEngine, checkpoint: CapturedCheckpointV1) -> SaveEnvelopeV1 {
    SaveEnvelopeV1 {
        schema_version: 1,
