...
| `chapter_1/scene_p2.json::/queue/47/assetCue/backgroundAssetId` | Rain Bell counter | Closing procedure setup | Espresso machine, whiteboard, counter wood | Counter-side close view shifts focus to operations and closure state | keep | B | Retain procedure-focused service view | Accepted |
...
| `chapter_1/scene_2.json::/queue/30/assetCue/backgroundAssetId` | Review-board entry | Procedural threshold | Service window, metal door, cold light | Narrow counter-window creates a new institutional depth cue | keep | B | Retain gatekeeping transition | Accepted |
| `chapter_1/scene_2.json::/queue/53/assetCue/backgroundAssetId` | Review-board exterior | Legal-pressure release | Stone steps, wet street, pale morning | Exterior widens from the entry window and resets the scene's breathing room | keep | B | Retain exterior pause | Accepted |
...
| `chapter_1/interrogation_scene_10.json::/phases/1/backgroundAssetId` | KAGAMI final hearing | Time-record comparison | Same table, time evidence, cold daylight | Distinct record arrangement advances the evidentiary state inside the intentional hold | keep | B | Retain uninterrupted hearing sightline | Accepted; same-view control |
| `chapter_1/interrogation_scene_10.json::/phases/2/backgroundAssetId` | KAGAMI final hearing | Backroom-plan reconstruction | Same table, official side, mapped floor-plan focus | Plan changes focal emphasis while preserving the courtroom geometry needed for argument continuity | keep | B | Retain uninterrupted hearing sightline | Accepted; same-view control |
| `chapter_1/interrogation_scene_10.json::/phases/3/backgroundAssetId` | KAGAMI final hearing | Limited-record authorization gate | Same table, presiding position, authorization form | Formal gate is legible as a state change through the centered authorization focus | keep | B | Retain uninterrupted hearing sightline | Accepted; same-view control |
| `chapter_1/interrogation_scene_10.json::/phases/4/backgroundAssetId` | KAGAMI final hearing | Doorlock-excerpt comparison | Same table, parallel record stacks, daylight | Parallel stacks give a new evidence relationship without breaking the hearing hold | keep | B | Retain uninterrupted hearing sightline | Accepted; same-view control |
| `chapter_1/interrogation_scene_10.json::/phases/5/backgroundAssetId` | KAGAMI final hearing | Final evidence-chain synthesis | Same table, work order, credential, memo, umbrella comparison | Culminating chain deliberately reuses the room while maximizing table-object contrast | keep | B | Retain uninterrupted hearing sightline | Accepted; same-view control |
...
| `chapter_1/scene_11.json::/queue/32/assetCue/backgroundAssetId` | Rain Bell front room evidence hold | Latte-and-clock unresolved beat | Window table, latte cup, old clock | Tighter table focus changes the cafe's function from social room to unresolved clue | keep | B | Retain clue-focused cafe hold | Accepted |
| `chapter_1/scene_11.json::/queue/44/assetCue/backgroundAssetId` | Soma office at night | USB discovery | Worn desk, lamp, laptop, rainy city window | First office-night plate introduces the new case object | keep | B | Retain USB focal reveal | Accepted |
| `chapter_1/scene_11.json::/queue/62/assetCue/backgroundAssetId` | Soma office at night | Transfer-list escalation | Same desk, laptop, practical lamp, added papers and phone | Same-view continuity is earned because the prop state visibly accumulates | keep | B | Retain evidence-accumulation hold | Accepted |
| `chapter_1/scene_11.json::/queue/72/assetCue/backgroundAssetId` | Rain Bell exterior late night | Blue-umbrella coda | Dark storefront, wet street, umbrella stand | Exterior returns to the cafe with a new lone-object focal clue | keep | B | Retain final exterior mystery hook | Accepted |
