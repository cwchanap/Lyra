...
**相馬律**：你今天也待了很久。那個保溫瓶也是你的？

**承包商主管**：這窗口開到五點。我每天泡一壺麥茶，撐到時間就走。
...
**北見修一**[defensive]：增田已經把那份草稿，存進監察信箱的草稿匣了。

**北見修一**[defensive]：我那組外包帳號，隔天就要面對合約審查、憑證收回。
...
**北見修一**[cornered]：八年。都是這種排法。

**北見修一**[cornered]：合約一到期就重簽，年資歸零。八年跟八天一樣。
...
**相馬律**[determined]：那個一直空著的第三人座位，現在能對到一個名字了。

**相馬律**[determined]：北見修一。臨時工單和外包憑證，先把名字對上。

**相馬律**[determined]：備忘裡的那個 K，這樣才能收口。

**相馬律**[determined]：傘套只留在動線脈絡裡。
