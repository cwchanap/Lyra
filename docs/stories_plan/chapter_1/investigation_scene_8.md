...
**店長高瀨**：對。然後我想起來，那晚我拍過維護頁。

**店長高瀨**：不是因為案子，是怕隔天門又卡住。
...
**相馬律**：事件 1842，外部維護憑證，後門開啟。

**相馬律**：事件 1843，員工憑證，後走廊開啟。
...
**相馬律**：事件 1842 是外包憑證，後門開。

**相馬律**：事件 1843 才是三宅的員工憑證。
...
**早坂茜**：那是摘要上的秒數，本機順序裡沒有。

**早坂茜**：要把它對清楚，得等核准片段；現在還不能下結論。
